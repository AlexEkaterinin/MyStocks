...
public abstract class Hilt_SearchStocksFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchStocksFragment() {
    super();
  }

  Hilt_SearchStocksFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchStocksFragment_GeneratedInjector) this.generatedComponent()).injectSearchStocksFragment(UnsafeCasts.<SearchStocksFragment>unsafeCast(this));
    }
  }
